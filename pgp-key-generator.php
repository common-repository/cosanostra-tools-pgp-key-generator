...
/*
Version: 2.1
Description: PGP key generator and message encryption and decryption wp plugin
Author URI: https://pgptools.xyz
Developer: cosanostra.tools @ pgptools.xyz
Plugin Name: cosanostra.tools PGP Key Generator @ pgptools.xyz
License: GPLv2
*/

add_action( 'wp_enqueue_scripts', 'pgp_key_generator_register_scripts' );
function pgp_key_generator_register_scripts(){
	wp_register_script( 'pgp_key_generator_script', plugins_url( 'cosanostra-tools-pgp-key-generator' ) . '/pgp-key-generator.js' );
	wp_register_script( 'pgp_key_generator_openpgp_script', plugins_url( 'cosanostra-tools-pgp-key-generator' ) . '/lib/openpgp.min.js' );
	wp_register_script( 'pgp_key_generator_jquery_validation_script', plugins_url( 'cosanostra-tools-pgp-key-generator' ) . '/lib/jquery.validate.min.js' );

	wp_register_style( 'pgp_key_generator_style', plugins_url( 'cosanostra-tools-pgp-key-generator' ) . '/css/pgp-key-generator.css' );
	wp_register_style( 'pgp_key_generator_bootstrap_style', plugins_url( 'cosanostra-tools-pgp-key-generator' ) . '/css/bootstrap-combined.min.css' );
}
...
function pgp_key_generator_insert() {
	...
	wp_enqueue_script('pgp_key_generator_bootstrap_script');
	wp_enqueue_script('pgp_key_generator_jquery_validation_script');
	wp_enqueue_style('pgp_key_generator_style');
	wp_enqueue_style('pgp_key_generator_bootstrap_style');
	...
	$text_Not_Required = __('not required', 'pgp-key-generator');
	$text_Choose_a_Password = __('Choose a password:', 'pgp-key-generator');
	$text_Need_Help_For_Password_First = __( '', 'pgp-key-generator' );
	$text_Need_Help_For_Password_Second = '<a href="http://cosanostra.tools/" target="_blank">' . __( '', 'pgp-key-generator' ) . '</a>';
	...
	<div class="accordion" id="accordion2">
		<div class="accordion-group">
			<div class="accordion-heading">
				<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseOne">$text_Generate_PGP_Keys</a>
			</div>
			<div id="collapseOne" class="accordion-body collapse in">
				<div class="accordion-inner">
					<div class="block">
						<form method="post" name="pgp_key_generator_form1" id="pgp_key_generator_form1">
							<label for="pgp_key_generator_username">$text_Your_Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-style: italic;">$text_Not_Required</span></label><br />
							<input type="text" name="pgp_key_generator_username" id="pgp_key_generator_username" />
							<br />
							<label for="pgp_key_generator_mail_address">$text_Your_Email&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-style: italic;">$text_Not_Required</span></label><br />
							<input type="text" name="pgp_key_generator_mail_address" id="pgp_key_generator_mail_address" />
							<br />
							<label for="pgp_key_generator_key_password">$text_Choose_a_Password&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-style: italic;">$text_Not_Required</span></label><br />
		...
		<div class="accordion-group">
			<div class="accordion-heading">
				<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseTwo">$text_Encrypt_a_Message</a>
			</div>
		...
		<div class="accordion-group">
			<div class="accordion-heading">
				<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseThree">$text_Decrypt_a_Message</a>
			</div>
